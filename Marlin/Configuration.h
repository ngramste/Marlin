...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 with Microswiss Hotend
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 with mirror bed
  #define DEFAULT_bedKp 111.02
  #define DEFAULT_bedKi 20.67
  #define DEFAULT_bedKd 64.60
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -8, -1.42 }
